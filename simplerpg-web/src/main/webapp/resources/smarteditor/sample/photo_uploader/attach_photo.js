    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/itsteam4/file_uploader_html5'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/itsteam4/photoUpload',	//샘플 URL입니다.
 	        sCallback : location.href.replace(/\/[^\/]*$/, '') + 'resources/smarteditor/sample/photo_uploader/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
