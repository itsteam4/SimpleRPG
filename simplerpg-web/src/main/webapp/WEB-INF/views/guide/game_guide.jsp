 ...
 <!-- Page Heading/Breadcrumbs -->
    ...
    <div class="jumbotron">
        ...
        <p style="color: 	#191970"> <img class="img-fluid rounded mb-3 mb-md-0" src="resources/image/guide/hero03.jpg" alt="">
           ...
           &nbsp
            <img class="img-fluid rounded mb-3 mb-md-0" src="resources/image/guide/hero02.jpg" alt="">
           &nbsp <img class="img-fluid rounded mb-3 mb-md-0" src="resources/image/guide/hero04.jpg" alt="">
            <br>
            <br>  이번 2D게임의 스토리는 <br>
              주인공은 어린시절부터 잠자기전에 꼬박 듣던, 숲의요정 이야기를 들으며 성장하였다.<br>
              그런던 어느날 꿈속에 숲의 요정이라는 무언가가 자신을 구해달라고 요청을했다.<br>
              놀라며 잠에서 깬 주인공은 꿈이 너무 생생하여, 어린시절 호기심을 자극했던<br> 숲의 요정을 구하기 위하여 
              무작정 모험을 떠난다.<br>
