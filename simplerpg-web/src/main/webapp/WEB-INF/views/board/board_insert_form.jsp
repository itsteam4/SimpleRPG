...
<body>
	<form id="board_form" name="board_form" action="boardinsert"
		...
		<div class="container" style="text-align: center">
			...
			<div class="row" style="margin-top: 30px">
				...
				<div class="input-group mb-3 col-md-6 ">
					<div class="input-group-prepend">
						<span class="input-group-text" style="width: 150px"> I D</span>
					</div>
			...
			<div class="row">
				<div class="col-md-3"></div>
				<div class="col-md-6">
					<textarea id="b_content" name="b_content" class="form-control"
						rows="10" style="resize: none" required="true"></textarea>
				</div>
				<div class="col-md-3"></div>
			</div>
			<div class="row" style="margin-top: 30px">
				...
				<div class="col-md-3">
					<button type="submit" id="confirm"
						class="btn btn-primary btn-block">등 록</button>
				</div>
				<div class="col-md-3">
